...
{
    public class GetCustomerRequestDtoValidator : AbstractValidator<GetCustomerRequestDto>

    {
        public GetCustomerRequestDtoValidator() 
        {
            RuleFor(c => c.Id)
            ...
            RuleFor(c => c.LastName)
                ...
                .MaximumLength(50).WithMessage("Soayd en fazla 50 karakter olmalıdır.");
            ...
            RuleFor(c => c.Created)
                .LessThanOrEqualTo(DateTime.Now).WithMessage("Oluşturma tarihi gelecekte olamaz.");
